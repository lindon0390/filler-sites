...
### 🎯 **НОВЫЙ: Полный флоу авторизации (протестирован через MCP):**
- ✅ **EvisaVietnamFullFlowPage**: новый Page Object для всего флоу авторизации
...
- ✅ **Ручной ввод капчи**: пауза для пользователя с понятными инструкциями
- ✅ **Выбор пользователя**: система выбора данных пользователя (001 по умолчанию)
- ✅ **Новые тесты**: `npm run test:full-flow:headed`
