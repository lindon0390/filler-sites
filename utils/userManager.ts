...
import { UserData } from '../pages/evisaVietnam.page';
...
export class UserManager {
    ...
    loadUserData(userId: string): UserData {
        ...
        const userData = JSON.parse(jsonContent) as UserData;
     ...
     */
    createUserTemplate(userId: string): UserData {
     ...
     */
    getUsersStatus(): { [userId: string]: { ready: boolean, hasData: boolean, hasImages: boolean } } {
        const status: { [userId: string]: { ready: boolean, hasData: boolean, hasImages: boolean } } = {};
