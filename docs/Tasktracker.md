...
#### Задача 4: Исправление поля страхования
- **Описание:** Исправить заполнение поля "Specify" для страхования
- **Значение:** "T-Insurance"
- **Сложность:** Низкая
- **Дедлайн:** 25.07.2025
- **Статус:** 🔄 В ожидании
- **Ответственный:** Разработчик

#### Задача 5: Добавление способа оплаты
- **Описание:** Добавить заполнение поля "Payment method"
