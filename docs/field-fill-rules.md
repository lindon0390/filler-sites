...
- ✅ Тип 3: Большой выпадающий список (large_dropdown) - 8 полей
- ✅ Тип 4: Зависимый выпадающий список (dependent_dropdown) - 1 поле
- ✅ Тип 5: Поле даты (date_picker) - 8 полей
- ✅ Тип 6: Радиокнопка (radio_button) - 9 полей
- ✅ Тип 7: Чекбокс (checkbox) - 3 поля
- ✅ Тип undefined: Загрузка файла (file_upload) - 2 поля
...
### Тип 3: Большой выпадающий список (large_dropdown)
- **Описание:** Ant Design Select с большим списком опций
...
### Тип 4: Зависимый выпадающий список (dependent_dropdown)
- **Описание:** Выпадающий список, зависящий от другого поля
...
- **Особенности:**
  ...
  - Использование логики большого выпадающего списка
...
### Тип undefined: Загрузка файла (file_upload)
...
- **Undefined (загрузка файлов):** 2 поля ✅
